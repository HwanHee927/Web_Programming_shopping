...
<body class="bg-gray-100">
        ...
        <div class="container mx-auto flex justify-between items-center p-5">
            ...
            <form method="post">
                <button type="submit" name="logout"
                    class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-400">로그아웃</button>
            </form>
            <?php
            } else {
            ?>
    ...
    <main class="container mx-auto mt-8 p-4">
        ...
        <div class="grid grid-rows-3 grid-cols-6 gap-4">
            <!-- 해당 div 영역 버튼은 기능 구현할 필요 X, 외관상 디자인으로만 존재 -->
            <button
        ...
        <div class="mt-8 flex justify-center gap-4">
            <form action="search.php" method="GET" class="flex">
                <input type="text" name="query" placeholder="검색하실 상품을 입력하시오."
                    class="border border-gray-300 p-4 w-1/2 rounded-l text-lg">
                <button type="submit"
