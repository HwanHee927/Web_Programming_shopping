        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <form method="POST" action="">
                ...
                <div class="flex justify-between items-center mt-4">
                    <button type="submit" name="delete" class="bg-gray-200 text-gray-700 px-4 py-2 rounded">선택 상품
                        삭제</button>
                    <!-- 체크 박스에 체크된 상품에 대해 버튼 클릭 시 폼 & DB 레코드 삭제 -->
                    <div class="text-lg font-bold text-right">선택한 상품금액: <?= number_format($total_price) ?>원</div>
                    <!--각 상품의 가격을 합산하여 변수로 출력할 것-->

                    <div>
                        <!-- 전체 상품 주문 버튼 -->
                        <a href="itemPaymentSuccess.html">
                            <button type="button" class="bg-gray-300 text-gray-700 px-4 py-2 rounded mr-2 border-none">
                                전체 상품 주문
                            </button>
                        </a>
                        <!-- 선택 상품 주문 버튼 -->
                        <button type="submit" class="bg-orange-500 text-white px-4 py-2 rounded border-none">선택 상품
                            주문</button>
                    </div>
                </div>
            </form>
